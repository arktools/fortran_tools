...
! AJT DIMENSION CL(20),ALSCHD(20),Z(6),CLSUB(20),ALSCH2(20),CD(20),
! AJT1          DCLPD(20),CLPWBS(20),CLTAN(20),CDCDO(20),CL2PAW(20)
...
! AJT IF NALPHA=20 IT WILL NOW BE 21 AFTER DO LOOP AND CL(I) WILL BE
! AJT OUTSIDE ARRAY BOUND 

! AJT IF(CL(I).EQ.0.0)GO TO 1100

! AJT PAGE 7.1.2.3-1 OF DATCOM SAYS NO ESTIMATE OF CNP VARIATION WITH CL
! AJT SHOULD BE MADE IF CL AND CD DATA NOT AVAILABLE 
